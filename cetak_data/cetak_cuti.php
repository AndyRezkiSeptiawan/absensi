...
<head>
    ...
    <title>Print Cuti Pegawai</title>
            ...
            <table class="table table-bordered">
                ...
                <?php
                    ...
                    if(isset($_GET['id'])){
                        ...
                        WHERE data_pegawai.nik='$id' AND status_cuti='Diterima'
                        ");
                        while($data = mysqli_fetch_assoc($sql)){
                            ...
                            $tgl = date('d-m-Y', STRTOTIME($data['waktu_pengajuan']));
                            $akhir = date('d-m-Y', STRTOTIME($data['akhir']));
                            $status = $data['status_cuti'];
