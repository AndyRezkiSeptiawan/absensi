...
<head>
    ...
    <title>Print Data Kenaikan Pangkat</title>
...
<div id="content book">
    ...
    <div class="page">
        ...
        <div class="title mt-5 text-center">
            <h3>LAPORAN DATA KENAIKAN PANGKAT PEGAWAI</h3>
            <?php
                if(!empty($_GET['mulai']) && !empty($_GET['akhir'])){
                    $mulai = date('d/m/Y',STRTOTIME($_GET['mulai']));
                ...
                <?php
                    ...
                    if(isset($_GET['mulai']) && isset($_GET['akhir'])){
                        ...
                        while($data = mysqli_fetch_array($sql)){
                            ...
                            $idp = $data['id_pegawai'];
                            $nama = $data['nama'];
                            $pangkatlm = $data['pangkat_lama'];
                            $pangkat = $data['pangkat'];
                            $gol = $data['golongan'];
                            $tgl = date('d-m-Y', STRTOTIME($data['waktu_perubahan']));
