...
<head>
    ...
    <title>Print Absen Masuk Dan Keluar</title>
...
<div id="content book">
    ...
    <div class="page">
        ...
        <div class="title mt-5 text-center">
            <h3>LAPORAN DATA ABSENSI PEGAWAI</h3>
        </div>
                ...
                <?php
                    if(isset($_GET['id'])){
                        ...
                        while($data = mysqli_fetch_array($sql)){
                            ...
                            $waktumsk = date('H:i', STRTOTIME($data[3]));
                            $waktuklr = date('H:i', STRTOTIME($data[4]));
                        ...
                        INNER JOIN data_pegawai ON absensi.id_pegawai = data_pegawai.id_pegawai
                        WHERE tgl BETWEEN '".$mulai."' AND '".$sampai."' ");
                        while($data = mysqli_fetch_array($sqlfilter)){
