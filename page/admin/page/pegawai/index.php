<div class="container-fluid" style="margin-bottom: 100px;">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <div class="btn-right">
            <a class='btn btn-secondary rounded-2' href="?page=pegawai/data-pegawai=tambah">Tambah Data</a>
    ...
    <div class="table-responsive">
        <table id="datatabel" class="table table-bordered table-hover" width="100%">
            ...
            <tbody>
                ...
                <tr align="center">
                    <td><?php echo $no++; ?></td>
                    <td><?php echo $row['id_pegawai']; ?><br><?php echo $row['nama']; ?></td>
                    ...
                    <td>
                        <div class="btn-group">
                            <!-- <a href="?page=pegawai/data-pegawai=qrcode&id=<?php echo $row['0'];?>" class="btn btn-primary mr-1"
                               >Buat QRCode</a> -->
                            <a href="?page=pegawai/data-pegawai=edit&id=<?php echo $row['0'];?>" class="btn btn-warning mr-1"
                               >Ubah</a>
                            <a href="?page=pegawai/data-pegawai=hapus&id=<?php echo $row['0']?>" class="btn btn-danger"
